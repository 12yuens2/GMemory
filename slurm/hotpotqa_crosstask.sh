#!/bin/bash
#SBATCH --job-name=vllm-hotpotqa-cross
#SBATCH --nodes=1
#SBATCH --gpus=4
#SBATCH --time=24:00:00
#SBATCH --exclusive
#SBATCH --output=out/hotpotqa-cross-%x.%j.%t.out
...
#   DB_DIR=/projects/<project>/results/sweep-2026-09 sbatch slurm/hotpotqa_crosstask.sh
