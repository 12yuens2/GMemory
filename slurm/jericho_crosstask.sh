#!/bin/bash
#SBATCH --job-name=vllm-jericho-cross
#SBATCH --nodes=1
#SBATCH --gpus=4
#SBATCH --time=24:00:00
#SBATCH --exclusive
#SBATCH --output=out/jericho-cross-%x.%j.%t.out
...
#   DB_DIR=/projects/<project>/results/sweep-2026-09 sbatch slurm/jericho_crosstask.sh
...
uv run tasks/run.py \
	--task jericho \
	--mas_type autogen \
	--mas_memory intrinsicmemory-notemplate intrinsicmemory-jericho \
