#!/bin/bash
#SBATCH --job-name=vllm-babyai
#SBATCH --nodes=1
#SBATCH --gpus=4
#SBATCH --time=24:00:00
#SBATCH --exclusive
#SBATCH --output=out/babyai-%x.%j.%t.out
...
#   DB_DIR=/projects/<project>/results/sweep-2026-09 sbatch slurm/babyai_experiment.sh
...
uv run tasks/run.py \
	...
	--mas_memory empty chatdev voyager memorybank generative metagpt g-memory \
	             intrinsicmemory-notemplate intrinsicmemory-babyai \
